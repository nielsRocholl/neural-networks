...
with open('helper_files/feature-metadata-vortex.json', 'r') as f:
    labels = json.load(f)
...
def extract_unlabelled():
    ...
    pkl_file = open("pkl/sampled-300_unlabelled_data.pkl", 'wb')
    pickle.dump(data, pkl_file)
    pkl_file.close

    pkl_file = open("pkl/sampled-300_unlabelled_names.pkl", 'wb')
    pickle.dump(cylinder_names, pkl_file)
    pkl_file.close

    pkl_file = open("pkl/sampled-300_unlabelled_data.pkl", 'rb')
    data = []
    data = pickle.load(pkl_file)

    pkl_file = open("pkl/sampled-300_unlabelled_names.pkl", 'rb')
    names = []
