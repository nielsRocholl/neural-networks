...
def extract_labelled():
    ...
    pkl_file = open("pkl/sampled-300_labelled_data.pkl", 'wb')
    pickle.dump(data, pkl_file)
    pkl_file.close

    pkl_file = open("pkl/sampled-300_labelled_names.pkl", 'wb')
    pickle.dump(cylinder_names, pkl_file)
    pkl_file.close

    pkl_file = open("pkl/sampled-300_labelled_data.pkl", 'rb')
    data = []
    data = pickle.load(pkl_file)

    pkl_file = open("pkl/sampled-300_labelled_names.pkl", 'rb')
    names = []
